                ...
                >
                    ...
                    >
                        <img
                            src={
                                logoUrl ||
                                '/src/assets/logos/reactbits-gh-white.svg'
                            }
                            alt="Logo"
                    ...
                    <div className="sm-panel-inner flex flex-1 flex-col gap-5">
                        ...
                        >
                            {items && items.length ? (
                                items.map((it, idx) => (
                                    <li
                                        className="sm-panel-itemWrap pointer-events-auto relative overflow-hidden leading-none"
                                        key={it.label + idx}
                                    >
                                        <a
                                ...
                                >
                                    ...
                                    >
                                        {socialItems.map((s, i) => (
                                            <li
                                                key={s.label + i}
                                                className="sm-socials-item pointer-events-auto"
                                            >
                                                <a
                                                    href={s.link}
                                                    target="_blank"
                        ...
                        {/* <AppearanceToggleTab className="pointer-events-auto" /> */}
                    </div>
                </aside>
            </div>
